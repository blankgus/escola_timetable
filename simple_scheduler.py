...
import random
from models import Aula, DIAS_SEMANA, HORARIOS_EFII, HORARIOS_EM
...
class SimpleGradeHoraria:
    ...
    def _alocar_aulas(self):
        """Aloca aulas na grade (implementação simplificada)"""
        try:
                ...
                for dia in dias_disponiveis:
                    for horario in horarios:
                        ...
                        if professor and sala:
                            ...
                            self.grade[turma_nome][dia][horario] = aula.to_dict()
                            idx_disciplina += 1
