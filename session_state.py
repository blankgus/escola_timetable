...
def init_session_state():
    ...
    if "professores" not in st.session_state:
        st.session_state.professores = database.carregar_professores() or [
            Professor("Ana A", ["Matemática"], {"sab", "dom"}, {4}, set()),
            Professor("Ana B", ["Matemática"], {"sab", "dom"}, {4}, set()),
            Professor("Bruno A", ["Português"], {"sab", "dom"}, {4}, set()),
            Professor("Bruno B", ["Português"], {"sab", "dom"}, {4}, set()),
            Professor("Carla A", ["História", "Geografia"], {"sab", "dom"}, {4}, set()),
            Professor("Carla B", ["História", "Geografia"], {"sab", "dom"}, {4}, set()),
            Professor("Diego A", ["Ciências", "Biologia"], {"sab", "dom"}, {4}, set()),
            Professor("Diego B", ["Ciências", "Biologia"], {"sab", "dom"}, {4}, set()),
            Professor("Eliane A", ["Inglês"], {"sab", "dom"}, {4}, set()),
            Professor("Eliane B", ["Inglês"], {"sab", "dom"}, {4}, set()),
            Professor("Fábio A", ["Educação Física"], {"sab", "dom"}, {4}, set()),
            Professor("Fábio B", ["Educação Física"], {"sab", "dom"}, {4}, set()),
            Professor("Gisele A", ["Artes"], {"sab", "dom"}, {4}, set()),
            Professor("Gisele B", ["Artes"], {"sab", "dom"}, {4}, set()),
            Professor("Hugo A", ["Física", "Matemática"], {"sab", "dom"}, {4}, set()),
            Professor("Hugo B", ["Física", "Matemática"], {"sab", "dom"}, {4}, set()),
            Professor("Isabel A", ["Química"], {"sab", "dom"}, {4}, set()),
            Professor("Isabel B", ["Química"], {"sab", "dom"}, {4}, set()),
            Professor("Jorge A", ["Filosofia", "Sociologia"], {"sab", "dom"}, {4}, set()),
            Professor("Jorge B", ["Filosofia", "Sociologia"], {"sab", "dom"}, {4}, set()),
        ]
